...
Religious groups
```{r pairwise_correlation_graph, message=FALSE, fig.width=10, fig.height=7}
word_cors %>%
...
Politicians
```{r pairwise_correlation_two_graph, message=FALSE, fig.width=10, fig.height=7}
word_cors %>%
...
Policies
```{r pairwise_correlation_three_graph, message=FALSE, fig.width=10, fig.height=7}
word_cors %>%
